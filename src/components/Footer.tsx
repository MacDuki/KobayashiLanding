    ...
    <footer id="footer" className="bg-dojo-black border-t border-dojo-cream/10 px-8 md:px-12 py-12">
      <div className="max-w-[1800px] mx-auto flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
        <div>
          ...
          <p className="text-dojo-muted text-sm mt-1">Shorin-Ryu Uruguay</p>
        </div>

        <div className="flex items-center gap-4">
          <a
            href="https://www.instagram.com/kobayashiuruguay/"
            target="_blank"
            rel="noopener noreferrer"
            className="w-10 h-10 rounded-full border border-dojo-cream/20 flex items-center justify-center text-dojo-cream/60 hover:text-[#E4405F] hover:border-[#E4405F]/50 transition-colors duration-500"
