      ...
      <div className="max-w-[1800px] mx-auto">
        <div className="grid md:grid-cols-12 gap-8 md:gap-16">
          <div className="md:col-span-4">
            <FadeIn>
              <p className="text-sm md:text-base tracking-[0.2em] uppercase text-dojo-muted mb-8">
                Preguntas frecuentes
              </p>
              <h2 className="font-display text-3xl md:text-4xl leading-tight text-dojo-cream">
