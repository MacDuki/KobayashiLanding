...
const faqs = [
  ...
  },
  {
    ...
    answer:
      'La cuota mensual es de UYU 1.000 e incluye las clases de Karate y Kobudo. La primera clase es gratuita y no hay matrícula. Consultá si necesitás confirmar disponibilidad.',
  },
]
...
export default function FAQ() {
  ...
  return (
    <section id="faq" className="bg-dojo-black py-14 md:py-20 px-8 md:px-12">
      <div className="max-w-[1800px] mx-auto">
        <div className="flex flex-col gap-12">
          ...
          <FadeIn delay={0.1}>
            <div className="border border-dojo-cream/10 rounded-2xl bg-dojo-cream/2 shadow-[0_4px_24px_-8px_rgba(0,0,0,0.5)] w-full max-w-3xl mx-auto overflow-hidden">
              {faqs.map((faq, i) => (
